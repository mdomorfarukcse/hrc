...
Redux::set_section( $opt_name, array(
    ...
    'fields' => array(
        array(
            ...
            'subtitle' => esc_html__( 'Main brand color (crimson).', 'hrc-developer' ),
            'default'  => '#9B1D34',
            'output'   => array( '--primary-green' ),
        ),
        array(
            'id'       => 'gradient_end_color',
            'type'     => 'color',
            'title'    => esc_html__( 'Gradient End Color', 'hrc-developer' ),
            'subtitle' => esc_html__( 'Navy blue gradient end color.', 'hrc-developer' ),
            'default'  => '#1E3066',
            'output'   => array( '--primary-green-dark' ),
        ),
        array(
            'id'       => 'accent_color',
            'type'     => 'color',
            'title'    => esc_html__( 'Accent Color', 'hrc-developer' ),
            'subtitle' => esc_html__( 'Accent/gold color for highlights.', 'hrc-developer' ),
            'default'  => '#D4AF37',
            'output'   => array( '--accent-gold' ),
        ),
        array(
            'id'       => 'header_bg_color',
            'type'     => 'color',
